...
class PyBoy:
    ...
    # symbols: Filepath to a .sym file to use. If unsure, specify `None`.
	...
	def __init__(
		self, gamerom, *, scale=defaults["scale"], symbols=None, bootrom=None,
		sound=False, sound_emulated=False, cgb=None, log_level=defaults["log_level"], **kwargs
	):
